...
MODEL_NAMES = ['enseignant', 'affectationclasse', 'periodesalaire', 'etatsalaire', 'presenceenseignant', 'detailheuresclasse']


def populate_sync_uuid(apps, schema_editor):
    for model_name in MODEL_NAMES:
        model = apps.get_model('salaires', model_name)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('salaires', '0003_presenceenseignant'),
    ]
