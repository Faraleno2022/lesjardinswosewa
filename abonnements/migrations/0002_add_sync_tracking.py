...
MODEL_NAMES = ['typeabonnement', 'itineraire', 'menucantine', 'abonnement', 'abonnementbus', 'abonnementcantine', 'presencecantine']


def populate_sync_uuid(apps, schema_editor):
    for model_name in MODEL_NAMES:
        model = apps.get_model('abonnements', model_name)
