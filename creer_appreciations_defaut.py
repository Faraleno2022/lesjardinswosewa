#!/usr/bin/env python
"""
Script pour ajouter des appréciations par défaut aux élèves maternels
Créé le 21/01/2026 pour résoudre le problème "Aucune appréciation saisie"
"""
...
def ajouter_appreciations_defaut():
    """Ajoute des appréciations par défaut pour tous les élèves d'une classe maternelle"""
    
    # Paramètres à modifier selon besoins
    CLASSE_ID = 75  # GRANDE SECTION
    ...
    try:
        ...
        appreciations_possibles = ['A+', 'A', 'B+', 'B', 'B-', 'C', 'D']
        ...
        for eleve in eleves:
            ...
            bulletin, created = BulletinMaternelle.objects.get_or_create(
                ...
                annee_scolaire=ANNEE_SCOLAIRE,
                defaults={
                    'analyses': ['comprend', 'fixe_attention', 'pas_probleme_camarades'],
                    'recommandations': ['encourager_feliciter', 'suivre_domicile'],
                    'appreciation_generale': f'Élève {eleve.prenom} montre un bon progrès ce trimestre.',
        ...
        print(f"\n✅ Les bulletins maternels peuvent maintenant être générés!")
...
if __name__ == "__main__":
    print("🚀 DÉMARRAGE - Ajout d'appréciations par défaut maternelles")
    print("="*60)
    ajouter_appreciations_defaut()
